#ifndef __CLOCK_CONFIG_AC7842X_H__
#define __CLOCK_CONFIG_AC7842X_H__
...
const Ckgen_ClkDivCfgType CLK_DIV[] = {
    ...
    {.Div = 2,  .Clk = CKGEN_CAN4_CLK},
    {.Div = 2,  .Clk = CKGEN_CAN5_CLK},
...
const Ckgen_ClkMuxCfgType CLK_DEV[] = {
    ...
    {.Clk = CKGEN_EIO_CLK,   .ClkSrc = CKGEN_HSI_DIV2_CLK },

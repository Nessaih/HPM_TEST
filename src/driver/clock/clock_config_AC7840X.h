#ifndef __CLOCK_CONFIG_AC7840X_H__
#define __CLOCK_CONFIG_AC7840X_H__
...
const Ckgen_PllCfgType CLK_SPLL = {
    ...
    .EnableSamp0LD = TRUE,
    .EnableSamp1LD = TRUE,
    .DlySel        = CKGEN_PLL_LD_DLY_SEL_2200PS,
    .PreDiv        = CKGEN_PLL_PRE_DIV_1U,
    .FbkDiv        = 120U,
    .PosDiv        = CKGEN_PLL_POS_DIV_8U,
};
...
const Ckgen_ClkDivCfgType CLK_DIV[] = {
    {.Div = 2,  .Clk = CKGEN_CAN0_CLK},
    {.Div = 2,  .Clk = CKGEN_CAN1_CLK},
    {.Div = 2,  .Clk = CKGEN_CAN2_CLK},
    {.Div = 2,  .Clk = CKGEN_CAN3_CLK},
...
const Ckgen_ClkMuxCfgType CLK_DEV[] = {
    ...
    {.Clk = CKGEN_ADC1_CLK,  .ClkSrc = CKGEN_SPLL_DIV2_CLK},
...
#endif //__CLOCK_CONFIG_AC7840X_H__
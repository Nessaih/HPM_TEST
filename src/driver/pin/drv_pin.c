...
static const pin_port_cfg_t pin_port_cfg[] = {
    ...
    {3U,  PIN_PULL_DISABLE, PIN_MUX_OPTION6, PIN_INT_DISABLE, PIN_SLEEP_DISABLE, PIN_DEFAULT},
    {4U,  PIN_PULL_DISABLE, PIN_MUX_OPTION6, PIN_INT_DISABLE, PIN_SLEEP_DISABLE, PIN_DEFAULT},

...
#define CFG_MAGEIC_VALUE 0x2334BACEU
...
/*配置定义*/
TBOX_CFG_DEFINE(MAGICNO, CFG_TYPE_NUMBER16, CFG_CAN_ERASE, "0x2334BACE", 4U);
...
TBOX_CFG_DEFINE(TIMEZONE, CFG_TYPE_STRING, CFG_CAN_ERASE, "+8", TBOX_CFG_TIMEZONE_LEN);
...
TBOX_CFG_DEFINE(DEVICETIME, CFG_TYPE_BYTE, CFG_CAN_ERASE, "", TBOX_CFG_DEVICETIME_LEN);

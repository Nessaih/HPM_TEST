...
TBOX_CFG_DEFINE(GPSMODE, CFG_TYPE_NUMBER, CFG_CAN_ERASE, "3", TBOX_CFG_GPSMODE_LEN); //range:[1-7]
TBOX_CFG_DEFINE(GPSRATE, CFG_TYPE_NUMBER, CFG_CAN_ERASE, "1", TBOX_CFG_GPSRATE_LEN); //value:[1,2,4,5,10]

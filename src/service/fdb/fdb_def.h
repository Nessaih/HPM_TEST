...
#define FDB_FILE_CACHE_TABLE_SIZE 2u
#endif
...
#define FDB_KVDB_CTRL_SET_DEFAULT_KV 0x0C /**< set default KV control command, this change MUST before database initialization */

...
* @file Compiler.h
*
* @brief the file used for specification of COMPILER Driver.
*/
#ifndef COMPILER_H
#define COMPILER_H
...
/* Prototypes for intrinsic functions */
    ...
    */
    ...
    /**
    * @brief Compiler abstraction for asm keyword.
    */
    ...
    */
    ...
    /**
    * @brief Function weak for reload.
    */
    #define WEAK __attribute__((weak))
#endif /* COMPILER_ARM_CC */
/* ARM CLANG */
#ifdef COMPILER_ARM_CLANG
/* Prototypes for intrinsic functions */
    /**
    * @brief The compiler abstraction shall provide the INLINE define for abstraction of the keyword
    *        inline.
